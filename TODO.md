...
- Legal pages: address (300 S Main St, Holly Springs, NC 27540) and governing law (North Carolina) are filled in. Contact email is support@hechoai.com and both pages are dated September 8, 2026. The company name on those pages is "Hecho AI"; replace with the registered legal entity name (LLC, Inc.) once known. Have a lawyer read both pages.
